    ...
    <a-collapse v-model:activeKey="activeKey">
      <a-collapse-panel key="0" header="用户基本信息">
        <a-form :model="formState" :rules="validateInfos">
          ...
          <template
            v-if="formState.userIdentity != 2 && formState.userIdentity != 3"
          >
            <div class="l-item clear">
            ...
            <div class="l-item clear">
              <div class="t-label f-fl">
                <span class="t-red">*</span>所处阶段：
              </div>
            ...
            <div class="l-item clear">
              <div class="t-label f-fl">
                <span class="t-red" v-if="formState.userIdentity != 1">*</span
                >请输入导师：
              </div>
